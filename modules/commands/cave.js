    ...
    switch(handleReply.type) {
        case "choosee": {
            ...
            switch(event.body) {
                ...
                case "2": msg = `⚡️𝑆𝑎𝑢 1 đ𝑒̂𝑚 𝑏𝑎̣𝑛 cho Đức Hà Tĩnh sờ dú  ${ku2} bạn 𝑘𝑖𝑒̂́𝑚 đ𝑢̛𝑜̛̣𝑐 ${pnl}vnd`; Currencies.increaseMoney(event.senderID, pnl); break;
