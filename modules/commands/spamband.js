module.exports.config = {
    ...
    hasPermssion: 2,
    credits: "NTKhang",
    description: "tự động cấm người dùng nếu spam bot 4 lần/120s",
...
module.exports.handleEvent = async function({ api, event, args, Users, Threads }) {
    ...
    if ((global.client.autoban[senderID].timeStart + 120000) <= Date.now()) {
        ...
        if (global.client.autoban[senderID].number >= 4) {
            ...
            var reason = "🚫spam bot 4 lần/120s🆙";
            data.banned = true;
...
module.exports.languages = {
    "vi": {
        "on": "Bật",
        "off": "Tắt",
        "successText": "Tự động cấm người dùng nếu spam bot 4 lần/120s trên nhóm này thành công",
    },
    "en": {
        "on": "on",
        "off": "off",
